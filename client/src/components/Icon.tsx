  ...
  const renderIcon = () => {
    ...
    switch (name) {
      ...
      case 'ruble-sign':
        return (
          <svg {...commonProps}>
            <path d="M13.5 3H7v18h2v-6h4.5c3.04 0 5.5-2.46 5.5-5.5S16.54 3 13.5 3zM9 5h4.5c1.93 0 3.5 1.57 3.5 3.5S15.43 12 13.5 12H9V5z" />
          </svg>
        );
      ...
      case 'package':
        return (
          <svg {...commonProps}>
            <path d="M12 2l3 3 3-3v6l-3 3-3-3V2zm0 10l-3 3v6l3-3 3 3v-6l-3-3z" />
          </svg>
        );
      ...
      case 'customs':
        return (
          <svg {...commonProps}>
            <path d="M12 2L4 5v6.09c0 5.05 3.41 9.76 8 10.91 4.59-1.15 8-5.86 8-10.91V5l-8-3zm-1 16.93c-3.95-.49-7-3.85-7-7.84V6.3l7-2.92v15.55zm2-15.55l7 2.92v4.79c0 3.99-3.05 7.35-7 7.84V3.38z" />
          </svg>
        );
      ...
      case 'cube':
        return (
          <svg {...commonProps}>
            <path d="M12 2l8 4.5v11L12 22l-8-4.5v-11L12 2zm0 2.31L6.5 7 12 9.69 17.5 7 12 4.31zM6 8.61v8.88l5 2.5v-8.88l-5-2.5zm7 11.38l5-2.5V8.61l-5 2.5v8.88z" />
          </svg>
        );
      ...
      case 'archive':
        return (
          <svg {...commonProps}>
            <path d="M20.54 5.23l-1.39-1.68C18.88 3.21 18.47 3 18 3H6c-.47 0-.88.21-1.16.55L3.46 5.23C3.17 5.57 3 6.02 3 6.5V19c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V6.5c0-.48-.17-.93-.46-1.27zM6.24 5h11.52l.83 1H5.42l.82-1zM5 19V8h14v11H5zm3-5h8v2H8v-2z" />
          </svg>
        );
      ...
      case 'exchange':
        return (
          <svg {...commonProps}>
            ...
            <path d="M6 8c1.1 0 2-.9 2-2s-.9-2-2-2-2 .9-2 2 .9 2 2 2zm0 2c-1.1 0-2 .9-2 2s.9 2 2 2 2-.9 2-2-.9-2-2-2zm0 6c-1.1 0-2 .9-2 2s.9 2 2 2 2-.9 2-2-.9-2-2-2zm12-8c1.1 0 2-.9 2-2s-.9-2-2-2-2 .9-2 2 .9 2 2 2zm0 2c-1.1 0-2 .9-2 2s.9 2 2 2 2-.9 2-2-.9-2-2-2zm0 6c-1.1 0-2 .9-2 2s.9 2 2 2 2-.9 2-2-.9-2-2-2z" />
          </svg>
        );
